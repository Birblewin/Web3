      ...
      <div className=" flex flex-row justify-between ">
          <div className=" overflow-hidden ">
              <div className="flex overflow-hidden ">
                <button type="button" className={`text-[#575c66] font-bold hover:bg-gray-200 py-2 px-4 rounded-md ${selected === 'ERC20' ? ' bg-[#fe4a3c] hover:bg-[#fe4a3c] text-[#f5f5f5]' : ''}`} onClick={() => handleClick('ERC20')}>ERC20</button>

                <button type="button" className={`text-[#575c66] font-bold hover:bg-gray-200 py-2 px-4 rounded-md ${selected === 'ERC721' ? ' bg-[#fe4a3c] hover:bg-[#fe4a3c] text-[#f5f5f5]' : ''}`} onClick={() => handleClick('ERC721')}>ERC721</button>


                <button type="button" className={`text-[#575c66] font-bold hover:bg-gray-200 py-2 px-4 rounded-md ${selected === 'Custom' ? ' bg-[#fe4a3c] hover:bg-[#fe4a3c] text-[#f5f5f5]' : ''}`} onClick={() => handleClick('Custom')}>Custom</button>
              </div>
          </div>
